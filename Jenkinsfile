        ...
        stage('Cloning Repos') {
            steps {
                dir(env.WORKSPACE + '/ts_wep') {
                    checkout scmGit(branches: [[name: 'refs/heads/'+env.BRANCH_NAME]], extensions: [lfs()], userRemoteConfigs: [[credentialsId: '14e4c262-1fb1-4b73-b395-5fe617420c85', url: 'https://github.com/lsst-ts/ts_wep.git']])
                }
            }
        }
