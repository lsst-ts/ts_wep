...
class CompensableImage(object):
    ...
    def makeBlendedMask(
        ...
        blendPadding : int or None, optional
            ...
            calculated automatically with `dilateBlendMask`. If an integer
            it must be >= 1. (the default is None.)
        compensated: bool, optional
            Whether to calculate masks for the compensated or original image.
            If True, mask will be in orientation of the compensated image.
            If False, mask will be in orientation of the original image.
    ...
    def createBlendedCoadd(self, maskArray, blendPadding=None):
        ...
        blendPadding : int or None, optional
            ...
            `dilateBlendMask`. If set to an integer value it must
            be >= 1. (the default is None.)
