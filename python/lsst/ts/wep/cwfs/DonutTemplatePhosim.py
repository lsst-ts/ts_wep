...
class DonutTemplatePhosim(DonutTemplateDefault):
    ...
    def makeTemplate(self, sensorName, defocalType, imageSize):
        ...
        # template Phosim templates from file are already a square
        ...
        if templateSize >= imageSize:
            ...
            # Find the left and right edges by trimming half pixels from left 
            # and right. Do the same for the top and bottom.
