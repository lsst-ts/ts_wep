...
class GenerateDonutCatalogTaskConnections(
...
class GenerateDonutCatalogTaskConfig(
    pipeBase.PipelineTaskConfig, pipelineConnections=GenerateDonutCatalogTaskConnections
):
...
class GenerateDonutCatalogTask(pipeBase.PipelineTask):
    ...
    def run(
        ...
        donutCatalog = refObjLoader.loadPixelBox(
            expBBox, expWcs, filterName=self.filterName
        )
